...
function App() {
 ...
 const buttonPress = (symbol: string)  => {
  ...
  const lastNumber = expression.split(/[-+/*]/g).pop();
      ...
      // if lastNumber already has a decimal, don't add another
     ...
     <div className="container" >
      ...
      <div id="calculator">
        <div id="display" style={{textAlign: "right"}}>
         ...
         <button id="clear" onClick={() => buttonPress ("clear")} className="ligth-gray">C</button> 
         <button id="negative" onClick={() => buttonPress ("negative")} className="ligth-gray">+/-</button>
         <button id="percent" onClick={() => buttonPress ("percent")} className="ligth-gray">%</button>
